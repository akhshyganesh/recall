...
function ShortcutRow({
  ...
  return (
    <div className="group grid min-h-11 grid-cols-[minmax(0,1fr)_auto] items-center gap-3 px-3 py-2 transition-colors hover:bg-muted/30">
...
function Recorder({
  ...
  return (
    <div className="flex items-center gap-2 rounded-sm bg-accent/50 px-2 py-1 text-[11px] ring-1 ring-accent">
