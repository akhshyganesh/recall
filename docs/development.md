...
- Antigravity (built-in chat sessions): macOS `$HOME/Library/Application Support/Antigravity/User/workspaceStorage/.../chatSessions/*.json` and `.../globalStorage/emptyWindowChatSessions/*.json`; Linux `$HOME/.config/Antigravity/User/workspaceStorage/.../chatSessions/*.json` and `.../globalStorage/emptyWindowChatSessions/*.json`; Windows `%APPDATA%\Antigravity\User\workspaceStorage\...\chatSessions\*.json` and `%APPDATA%\Antigravity\User\globalStorage\emptyWindowChatSessions\*.json`
