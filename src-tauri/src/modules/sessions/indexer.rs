use crate::modules::sessions::connectors;
...
fn tool_display_name(slug: &str) -> String {
    match slug {
        "copilot" => "GitHub Copilot (VS Code)".to_string(),
...
mod tests {
    ...
    use crate::modules::sessions::models::{NormalizedConversation, NormalizedMessage};
